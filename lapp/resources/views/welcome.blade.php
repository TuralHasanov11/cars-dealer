...
@section('landing')
<div class="cover-container d-flex flex-column justify-content-center align-items-start" style="background: url({{asset('images/core-images/cover.jpg')}}) fixed no-repeat; background-size:100% 100%;">
    <div class="col-12 col-md-6 col-lg-3 ml-md-5">
        <h1 class="my-4 text-main">Xəyalındakı avtomobili axtar</h1>
        <div class="text-light">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum, et excepturi.</div> 
        <a href="#cars" class="btn btn-main my-4 font-weight-bold scroll-link">Ətraflı</a>
    </div>
</div>
                ...
                @foreach ($cars as $car)
                    <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="card bg-dark-full bg-gradient text-main border-0" style="height: 100%">
                            ...
                            <div class="card-body border-0 car-details">
                                <h6 class="card-title">{{$car->carModel->brand->name}} {{$car->carModel->name}}</h6>
                                ...
                                <p class="card-text d-flex justify-content-between">
                                    ...
                                    @endif
                                    <a href="{{route('cars.show',['car'=>$car->id])}}" class="btn btn-main car-more-info">Ətraflı</a>
                                </p>
                            </div>
                        </div>
                    </div>
