...
<div class="cars-area py-5" id="cars">
    <h1 class="text-center text-main">Seçilmişlər</h1>
    <div class="container">
                            ...
                            <div class="col-12 col-md-6 col-xl-4">
                                <div class="card bg-dark-full bg-gradient text-main border-0" style="height: 100%">
                                    <div class="card-image-container">
                                        <img class="card-image" src="{{asset($car->images->where('type','front')->first()->url)}}" alt="{{$car->carModel->brand->name}} {{$car->carModel->name}}">
                                        <p class="car-info">
                                    ...
                                    <div class="card-body border-0">
                                        ...
                                        <p class="card-text d-flex justify-content-between">
                                            <app-car-bookmark remove="{{true}}" :clear="{{'true'}}" url="{{route('cars.show',['car'=>$car->id])}}"></app-car-bookmark>
